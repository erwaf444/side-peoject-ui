...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] '>
        ...
        <div onClick={handleClick} className='md:hidden custom-fabar-color z-10'>
            {!nav ? <FaBars/> : <FaTimes/> }
        </div>
        ...
        <div className='hidden lg:flex fixed flex-col top-[35%] left-0 '>
            <ul>
                <li className='text-white w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600 '> 
                ...
                <li className='text-white w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#565f89] '> 
                    <a className='flex justify-between items-center w-full text-gray-300' href="/">
